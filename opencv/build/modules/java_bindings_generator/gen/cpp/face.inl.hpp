...
#include "C:/Users/d_dan/Desktop/opencv-master\../opencv_contrib-master/modules/face\include\opencv2\face.hpp"
#include "C:/Users/d_dan/Desktop/opencv-master\../opencv_contrib-master/modules/face\include\opencv2\face\bif.hpp"
#include "C:/Users/d_dan/Desktop/opencv-master\../opencv_contrib-master/modules/face\include\opencv2\face\facemark.hpp"
#include "C:/Users/d_dan/Desktop/opencv-master\../opencv_contrib-master/modules/face\include\opencv2\face\facemarkAAM.hpp"
#include "C:/Users/d_dan/Desktop/opencv-master\../opencv_contrib-master/modules/face\include\opencv2\face\facemarkLBF.hpp"
#include "C:/Users/d_dan/Desktop/opencv-master\../opencv_contrib-master/modules/face\include\opencv2\face\facemark_train.hpp"
#include "C:/Users/d_dan/Desktop/opencv-master\../opencv_contrib-master/modules/face\include\opencv2\face\facerec.hpp"
#include "C:/Users/d_dan/Desktop/opencv-master\../opencv_contrib-master/modules/face\include\opencv2\face\face_alignment.hpp"
#include "C:/Users/d_dan/Desktop/opencv-master\../opencv_contrib-master/modules/face\include\opencv2\face\mace.hpp"
#include "C:/Users/d_dan/Desktop/opencv-master\../opencv_contrib-master/modules/face\include\opencv2\face\predict_collector.hpp"
  ...
  (JNIEnv* env, jclass , jlong image_nativeObj, jlong faces_nativeObj, jstring face_cascade_name)
{
    ...
    try {
        ...
        bool _retval_ = cv::face::getFacesHAAR( image, faces, n_face_cascade_name );
        return _retval_;
    } catch(const std::exception &e) {
        throwJavaException(env, &e, method_name);
    } catch (...) {
  ...
  (JNIEnv* env, jclass , jstring imageList, jstring annotationList, jobject images_list, jobject annotations_list)
{
    ...
    try {
        ...
        bool _retval_ = cv::face::loadDatasetList( n_imageList, n_annotationList, images, annotations );
        return _retval_;
    } catch(const std::exception &e) {
        throwJavaException(env, &e, method_name);
    } catch (...) {
  ...
  (JNIEnv* env, jclass , jstring filename, jlong points_nativeObj, jfloat offset)
{
    ...
    try {
        ...
        bool _retval_ = cv::face::loadFacePoints( n_filename, points, (float)offset );
        return _retval_;
    } catch(const std::exception &e) {
        throwJavaException(env, &e, method_name);
    } catch (...) {
  ...
  (JNIEnv* env, jclass , jstring filename, jlong points_nativeObj)
{
    ...
    try {
        ...
        const char* utf_filename = env->GetStringUTFChars(filename, 0); String n_filename( utf_filename ? utf_filename : "" ); env->ReleaseStringUTFChars(filename, utf_filename);
        Mat& points = *((Mat*)points_nativeObj);
        bool _retval_ = cv::face::loadFacePoints( n_filename, points );
        return _retval_;
    } catch(const std::exception &e) {
        throwJavaException(env, &e, method_name);
    } catch (...) {
  ...
  (JNIEnv* env, jclass , jstring filename, jobject images_list, jlong facePoints_nativeObj, jchar delim, jfloat offset)
{
    ...
    try {
        ...
        bool _retval_ = cv::face::loadTrainingData( n_filename, images, facePoints, (char)delim, (float)offset );
        return _retval_;
    } catch(const std::exception &e) {
        throwJavaException(env, &e, method_name);
    } catch (...) {
  ...
  (JNIEnv* env, jclass , jstring filename, jobject images_list, jlong facePoints_nativeObj, jchar delim)
{
    ...
    try {
        ...
        const char* utf_filename = env->GetStringUTFChars(filename, 0); String n_filename( utf_filename ? utf_filename : "" ); env->ReleaseStringUTFChars(filename, utf_filename);
        Mat& facePoints = *((Mat*)facePoints_nativeObj);
        bool _retval_ = cv::face::loadTrainingData( n_filename, images, facePoints, (char)delim );
        return _retval_;
    } catch(const std::exception &e) {
        throwJavaException(env, &e, method_name);
    } catch (...) {
  ...
  (JNIEnv* env, jclass , jstring filename, jobject images_list, jlong facePoints_nativeObj)
{
    ...
    try {
        ...
        const char* utf_filename = env->GetStringUTFChars(filename, 0); String n_filename( utf_filename ? utf_filename : "" ); env->ReleaseStringUTFChars(filename, utf_filename);
        Mat& facePoints = *((Mat*)facePoints_nativeObj);
        bool _retval_ = cv::face::loadTrainingData( n_filename, images, facePoints );
        return _retval_;
    } catch(const std::exception &e) {
        throwJavaException(env, &e, method_name);
    } catch (...) {
  ...
  (JNIEnv* env, jclass , jstring imageList, jstring groundTruth, jobject images_list, jlong facePoints_nativeObj, jfloat offset)
{
    ...
    try {
        ...
        Mat& facePoints = *((Mat*)facePoints_nativeObj);
        bool _retval_ = cv::face::loadTrainingData( n_imageList, n_groundTruth, images, facePoints, (float)offset );
        return _retval_;
    } catch(const std::exception &e) {
        throwJavaException(env, &e, method_name);
    } catch (...) {
  ...
  (JNIEnv* env, jclass , jstring imageList, jstring groundTruth, jobject images_list, jlong facePoints_nativeObj)
{
    ...
    try {
        ...
        const char* utf_groundTruth = env->GetStringUTFChars(groundTruth, 0); String n_groundTruth( utf_groundTruth ? utf_groundTruth : "" ); env->ReleaseStringUTFChars(groundTruth, utf_groundTruth);
        Mat& facePoints = *((Mat*)facePoints_nativeObj);
        bool _retval_ = cv::face::loadTrainingData( n_imageList, n_groundTruth, images, facePoints );
        return _retval_;
    } catch(const std::exception &e) {
        throwJavaException(env, &e, method_name);
    } catch (...) {
  ...
  (JNIEnv* env, jclass , jobject filename_list, jlong trainlandmarks_mat_nativeObj, jobject trainimages_list)
{
    ...
    try {
        ...
        bool _retval_ = cv::face::loadTrainingData( filename, trainlandmarks, trainimages );
        return _retval_;
    } catch(const std::exception &e) {
        throwJavaException(env, &e, method_name);
    } catch (...) {
  ...
  (JNIEnv* env, jclass , jlong self, jlong src_nativeObj, jdoubleArray label_out, jdoubleArray confidence_out)
{
    ...
    try {
        ...
        jdouble tmp_label[1] = {(jdouble)label}; env->SetDoubleArrayRegion(label_out, 0, 1, tmp_label);  jdouble tmp_confidence[1] = {(jdouble)confidence}; env->SetDoubleArrayRegion(confidence_out, 0, 1, tmp_confidence);
        return;
    } catch(const std::exception &e) {
        throwJavaException(env, &e, method_name);
    } catch (...) {
  ...
  (JNIEnv* env, jclass , jlong self)
{
    ...
    try {
        LOGD("%s", method_name);
        Ptr<cv::face::BIF>* me = (Ptr<cv::face::BIF>*) self; //TODO: check for NULL
        int _retval_ = (*me)->getNumRotations(  );
        return _retval_;
    } catch(const std::exception &e) {
        throwJavaException(env, &e, method_name);
    } catch (...) {
  ...
  (JNIEnv* env, jclass , jlong self)
{
    ...
    try {
        LOGD("%s", method_name);
        Ptr<cv::face::BasicFaceRecognizer>* me = (Ptr<cv::face::BasicFaceRecognizer>*) self; //TODO: check for NULL
        int _retval_ = (*me)->getNumComponents(  );
        return _retval_;
    } catch(const std::exception &e) {
        throwJavaException(env, &e, method_name);
    } catch (...) {
