...
#include "C:/Users/d_dan/Desktop/opencv-master\modules/features2d\misc/java/src/cpp/features2d_converters.hpp"
#include "C:/Users/d_dan/Desktop/opencv-master\modules/features2d\include/opencv2/features2d.hpp"
  ...
  (JNIEnv* env, jclass , jint nfeatures, jfloat scaleFactor, jint nlevels, jint edgeThreshold, jint firstLevel, jint WTA_K, jint scoreType, jint patchSize)
{
    ...
    try {
        LOGD("%s", method_name);
        typedef Ptr<cv::ORB> Ptr_ORB;
        Ptr_ORB _retval_ = cv::ORB::create( (int)nfeatures, (float)scaleFactor, (int)nlevels, (int)edgeThreshold, (int)firstLevel, (int)WTA_K, (int)scoreType, (int)patchSize );
        return (jlong)(new Ptr_ORB(_retval_));
    } catch(const std::exception &e) {
        throwJavaException(env, &e, method_name);
    } catch (...) {
  ...
  (JNIEnv* env, jclass , jint nfeatures, jfloat scaleFactor, jint nlevels, jint edgeThreshold, jint firstLevel, jint WTA_K, jint scoreType)
{
    ...
    try {
        LOGD("%s", method_name);
        typedef Ptr<cv::ORB> Ptr_ORB;
        Ptr_ORB _retval_ = cv::ORB::create( (int)nfeatures, (float)scaleFactor, (int)nlevels, (int)edgeThreshold, (int)firstLevel, (int)WTA_K, (int)scoreType );
        return (jlong)(new Ptr_ORB(_retval_));
    } catch(const std::exception &e) {
        throwJavaException(env, &e, method_name);
    } catch (...) {
  ...
  (JNIEnv* env, jclass , jint descriptor_type, jint descriptor_size, jint descriptor_channels, jfloat threshold, jint nOctaves, jint nOctaveLayers)
{
    ...
    try {
        LOGD("%s", method_name);
        typedef Ptr<cv::AKAZE> Ptr_AKAZE;
        Ptr_AKAZE _retval_ = cv::AKAZE::create( (int)descriptor_type, (int)descriptor_size, (int)descriptor_channels, (float)threshold, (int)nOctaves, (int)nOctaveLayers );
        return (jlong)(new Ptr_AKAZE(_retval_));
    } catch(const std::exception &e) {
        throwJavaException(env, &e, method_name);
    } catch (...) {
  ...
  (JNIEnv* env, jclass , jint descriptor_type, jint descriptor_size, jint descriptor_channels, jfloat threshold, jint nOctaves)
{
    ...
    try {
        LOGD("%s", method_name);
        typedef Ptr<cv::AKAZE> Ptr_AKAZE;
        Ptr_AKAZE _retval_ = cv::AKAZE::create( (int)descriptor_type, (int)descriptor_size, (int)descriptor_channels, (float)threshold, (int)nOctaves );
        return (jlong)(new Ptr_AKAZE(_retval_));
    } catch(const std::exception &e) {
        throwJavaException(env, &e, method_name);
    } catch (...) {
  ...
  (JNIEnv* env, jclass , jint descriptor_type, jint descriptor_size, jint descriptor_channels, jfloat threshold)
{
    ...
    try {
        LOGD("%s", method_name);
        typedef Ptr<cv::AKAZE> Ptr_AKAZE;
        Ptr_AKAZE _retval_ = cv::AKAZE::create( (int)descriptor_type, (int)descriptor_size, (int)descriptor_channels, (float)threshold );
        return (jlong)(new Ptr_AKAZE(_retval_));
    } catch(const std::exception &e) {
        throwJavaException(env, &e, method_name);
    } catch (...) {
  ...
  (JNIEnv* env, jclass , jint descriptor_type, jint descriptor_size, jint descriptor_channels)
{
    ...
    try {
        LOGD("%s", method_name);
        typedef Ptr<cv::AKAZE> Ptr_AKAZE;
        Ptr_AKAZE _retval_ = cv::AKAZE::create( (int)descriptor_type, (int)descriptor_size, (int)descriptor_channels );
        return (jlong)(new Ptr_AKAZE(_retval_));
    } catch(const std::exception &e) {
        throwJavaException(env, &e, method_name);
    } catch (...) {
  ...
  (JNIEnv* env, jclass , jint descriptor_type, jint descriptor_size)
{
    ...
    try {
        LOGD("%s", method_name);
        typedef Ptr<cv::AKAZE> Ptr_AKAZE;
        Ptr_AKAZE _retval_ = cv::AKAZE::create( (int)descriptor_type, (int)descriptor_size );
        return (jlong)(new Ptr_AKAZE(_retval_));
    } catch(const std::exception &e) {
        throwJavaException(env, &e, method_name);
    } catch (...) {
  ...
  (JNIEnv* env, jclass , jint descriptor_type)
{
    ...
    try {
        LOGD("%s", method_name);
        typedef Ptr<cv::AKAZE> Ptr_AKAZE;
        Ptr_AKAZE _retval_ = cv::AKAZE::create( (int)descriptor_type );
        return (jlong)(new Ptr_AKAZE(_retval_));
    } catch(const std::exception &e) {
        throwJavaException(env, &e, method_name);
    } catch (...) {
