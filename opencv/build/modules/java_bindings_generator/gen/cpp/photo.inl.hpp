...
#include "C:/Users/d_dan/Desktop/opencv-master\modules/photo\include\opencv2\photo\photo_c.h"
#include "C:/Users/d_dan/Desktop/opencv-master\modules/photo\include\opencv2\photo.hpp"
...
//
//  Ptr_TonemapDurand cv::createTonemapDurand(float gamma = 1.0f, float contrast = 4.0f, float saturation = 1.0f, float sigma_space = 2.0f, float sigma_color = 2.0f)
//
...
JNIEXPORT jlong JNICALL Java_org_opencv_photo_Photo_createTonemapDurand_11 (JNIEnv*, jclass, jfloat, jfloat, jfloat, jfloat);
  ...
  (JNIEnv* env, jclass , jfloat gamma, jfloat contrast, jfloat saturation, jfloat sigma_space)
{
    ...
    try {
        LOGD("%s", method_name);
        typedef Ptr<cv::TonemapDurand> Ptr_TonemapDurand;
        Ptr_TonemapDurand _retval_ = cv::createTonemapDurand( (float)gamma, (float)contrast, (float)saturation, (float)sigma_space );
        return (jlong)(new Ptr_TonemapDurand(_retval_));
    } catch(const std::exception &e) {
        throwJavaException(env, &e, method_name);
    } catch (...) {
...
JNIEXPORT jlong JNICALL Java_org_opencv_photo_Photo_createTonemapDurand_12 (JNIEnv*, jclass, jfloat, jfloat, jfloat);

JNIEXPORT jlong JNICALL Java_org_opencv_photo_Photo_createTonemapDurand_12
  (JNIEnv* env, jclass , jfloat gamma, jfloat contrast, jfloat saturation)
{
    static const char method_name[] = "photo::createTonemapDurand_12()";
    try {
        LOGD("%s", method_name);
        typedef Ptr<cv::TonemapDurand> Ptr_TonemapDurand;
        Ptr_TonemapDurand _retval_ = cv::createTonemapDurand( (float)gamma, (float)contrast, (float)saturation );
        return (jlong)(new Ptr_TonemapDurand(_retval_));
    } catch(const std::exception &e) {
        throwJavaException(env, &e, method_name);
    } catch (...) {
...
JNIEXPORT jlong JNICALL Java_org_opencv_photo_Photo_createTonemapDurand_13 (JNIEnv*, jclass, jfloat, jfloat);

JNIEXPORT jlong JNICALL Java_org_opencv_photo_Photo_createTonemapDurand_13
  (JNIEnv* env, jclass , jfloat gamma, jfloat contrast)
{
    static const char method_name[] = "photo::createTonemapDurand_13()";
    try {
        LOGD("%s", method_name);
        typedef Ptr<cv::TonemapDurand> Ptr_TonemapDurand;
        Ptr_TonemapDurand _retval_ = cv::createTonemapDurand( (float)gamma, (float)contrast );
        return (jlong)(new Ptr_TonemapDurand(_retval_));
    } catch(const std::exception &e) {
        throwJavaException(env, &e, method_name);
    } catch (...) {
...
JNIEXPORT jlong JNICALL Java_org_opencv_photo_Photo_createTonemapDurand_14 (JNIEnv*, jclass, jfloat);

JNIEXPORT jlong JNICALL Java_org_opencv_photo_Photo_createTonemapDurand_14
  (JNIEnv* env, jclass , jfloat gamma)
{
    static const char method_name[] = "photo::createTonemapDurand_14()";
    try {
        LOGD("%s", method_name);
        typedef Ptr<cv::TonemapDurand> Ptr_TonemapDurand;
        Ptr_TonemapDurand _retval_ = cv::createTonemapDurand( (float)gamma );
        return (jlong)(new Ptr_TonemapDurand(_retval_));
    } catch(const std::exception &e) {
        throwJavaException(env, &e, method_name);
    } catch (...) {
...
JNIEXPORT jlong JNICALL Java_org_opencv_photo_Photo_createTonemapDurand_15 (JNIEnv*, jclass);

JNIEXPORT jlong JNICALL Java_org_opencv_photo_Photo_createTonemapDurand_15
  (JNIEnv* env, jclass )
{
    static const char method_name[] = "photo::createTonemapDurand_15()";
    try {
        LOGD("%s", method_name);
        typedef Ptr<cv::TonemapDurand> Ptr_TonemapDurand;
...
//
//  float cv::TonemapDurand::getContrast()
//
...
//
//  float cv::TonemapDurand::getSaturation()
//
...
//
//  float cv::TonemapDurand::getSigmaColor()
//
...
//
//  float cv::TonemapDurand::getSigmaSpace()
//
...
//
//  void cv::TonemapDurand::setContrast(float contrast)
//
...
//
//  void cv::TonemapDurand::setSaturation(float saturation)
//
...
//
//  void cv::TonemapDurand::setSigmaColor(float sigma_color)
//
...
//
//  void cv::TonemapDurand::setSigmaSpace(float sigma_space)
//
