...
public class StandAloneAnnie {
	...
	public static void main(String args[]) throws GateException, IOException {
		...
		while(iter.hasNext()) {
			...
			//ANOTAR LOS TIPOS QUE NOS INTERESAN PARA NUESTRA APLICACIÓN
			...
			//Set que contiene las etiquetas detectadas en el texto
			Set<Annotation> etiquetas =
			...
			if(originalContent != null && info != null) {
				...
				Out.prln("Unsorted annotations count: "+etiquetas.size());
			...
			String xmlDocument = doc.toXml(etiquetas, false);
